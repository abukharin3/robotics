...
if __name__ == "__main__":
	...
	model = HERON("MlpPolicy", env, verbose=True, learning_rate=3e-4, heirarchy=order, factor_dim=factor_dim, multiple_sigmas=multiple_sigmas, heron=False, heuristic=True, alpha=args.alpha)
